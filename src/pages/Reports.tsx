...
const Reports: React.FC = () => {
  ...
  const getStatusBadge = (status: Report['status']) => {
    switch (status) {
      ...
      case 'conditional':
        return <span className="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full">
            Conditionally Suitable
          </span>;
      case 'unsuitable':
        return <span className="bg-red-100 text-red-800 text-xs px-2 py-1 rounded-full">
            Not Recommended
          </span>;
    }
  };
  ...
  return <MainLayout>
      <div className="mb-6 flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">View and manage your past assessments</p>
        </div>
      ...
      <Card className="mb-6 p-4">
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="relative flex-1">
            ...
            <input type="text" placeholder="Search reports..." className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-blue-500" />
          </div>
      ...
      <div className="space-y-4">
        {reports.map(report => <Card key={report.id} className="p-4 hover:shadow-md transition-shadow">
      ...
      {reports.length === 0 && <div className="text-center py-12">
          ...
          <p className="text-gray-600 mb-6">
            Start your first assessment to generate a report.
          </p>
          <Button variant="primary" onClick={() => navigate('/assessment')}>
            Start Assessment
          </Button>
