...
const Dashboard: React.FC = () => {
  ...
  return <MainLayout>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <h2 className="text-xl font-semibold mb-4">Rainfall Patterns</h2>
          <Card className="h-64 p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="font-medium">Hourly Precipitation, Rain & Showers</h3>
            ...
            <div className="mt-2 text-xs text-gray-500">Blue: Precipitation, Cyan: Rain, Purple: Showers</div>
          </Card>
        </div>
      <div>
