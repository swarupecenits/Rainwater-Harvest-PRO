...
const Signup: React.FC = () => {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    setError('');
    try {
      const data = await apiFetch<{ token: string; message?: string }>('/api/auth/signup', {
        method: 'POST',
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                ...
                <button type="button" aria-label="Continue with Facebook" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-lg shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50">
                  <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
