          ...
          <Card className="mb-6 p-6">
              ...
              <div className="ml-4">
                <h2 className="text-xl font-semibold">
                  {t('results.feasibility', {
                    defaultValue: 'Feasibility: Highly Suitable',
                  })}
                </h2>
                <p className="text-gray-600">
                  {t('results.feasibilityDesc', {
                    defaultValue:
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
              ...
              <div className="bg-green-50 rounded-lg p-4 text-center">
                ...
                <h3 className="font-semibold">{t('results.rainfall')}</h3>
              ...
              <div className="bg-cyan-50 rounded-lg p-4 text-center">
                ...
                <h3 className="font-semibold">{t('results.potential')}</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              <div className="border border-gray-200 rounded-lg p-4 flex">
                ...
                <div>
                  <h4 className="font-medium">{t('results.storageTank')}</h4>
                  <p className="text-gray-600 text-sm">5,000 L capacity underground tank</p>
                </div>
              </div>
              <div className="border border-gray-200 rounded-lg p-4 flex">
                ...
                <div>
                  <h4 className="font-medium">{t('results.rechargePit')}</h4>
                  <p className="text-gray-600 text-sm">2m x 2m x 2m with filter media</p>
                </div>
              </div>
            </div>
            ...
            <h3 className="font-semibold text-lg mb-3">
              {t('results.rainfallDistribution')}
            </h3>
            <div className="bg-gray-50 rounded-lg p-4 h-64 mb-6">
              ...
              <div className="relative h-48">
                <div className="absolute bottom-0 left-0 right-0 flex items-end justify-around h-40">
                  {[65, 45, 75, 95, 120, 150, 180, 165, 130, 90, 70, 60].map((value, i) => (
            ...
            {/* Groundwater Level */}
            <h3 className="font-semibold text-lg mb-3">{t('results.groundwaterLevel')}</h3>
            <div className="bg-gray-50 rounded-lg p-4 mb-6">
              ...
              <p className="mt-2 text-sm text-gray-600">{t('results.groundwaterDesc')}</p>
            </div>
          </Card>
        </div>
          ...
          <Card className="p-6 mb-6">
            ...
            <div className="mb-4">
              <div className="flex justify-between mb-1">
                <span className="text-gray-600">{t('results.storageTank')}</span>
                <span className="font-medium">$1,200</span>
              </div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-600">{t('results.rechargePit')}</span>
                <span className="font-medium">$800</span>
              </div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-600">{t('results.guttersPipes')}</span>
                <span className="font-medium">$400</span>
              </div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-600">{t('results.filtrationSystem')}</span>
                <span className="font-medium">$300</span>
              </div>
              <div className="flex justify-between mb-1">
                <span className="text-gray-600">{t('results.installation')}</span>
                <span className="font-medium">$1,100</span>
              </div>
              <div className="border-t border-gray-200 mt-2 pt-2 flex justify-between">
                <span className="font-semibold">{t('results.totalEstimatedCost')}</span>
            ...
            <div className="mt-6">
              ...
              <div className="bg-green-50 rounded-lg p-4 text-center mb-4">
                ...
                <p className="text-sm text-gray-500">{t('results.paybackPeriod')}</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="flex items-center mb-2">
                  ...
                  <span className="text-sm">{t('results.waterSavedAnnually')}</span>
                </div>
                <div className="flex items-center">
                  <BarChart2Icon className="h-5 w-5 text-green-600 mr-2" />
                  <span className="text-sm">{t('results.reducedRunoff')}</span>
                </div>
              </div>
            </div>
          </Card>
          ...
          <Card className="p-6">
            ...
            <div className="space-y-4">
              <div className="flex items-start">
                ...
                <p className="text-sm text-gray-600">{t('results.step1')}</p>
              </div>
              <div className="flex items-start">
                <div className="bg-blue-100 rounded-full p-1 mr-3">
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-blue-600 text-xs text-white">
                ...
                <p className="text-sm text-gray-600">{t('results.step2')}</p>
              </div>
              <div className="flex items-start">
                <div className="bg-blue-100 rounded-full p-1 mr-3">
                  <span className="flex h-5 w-5 items-center justify-center rounded-full bg-blue-600 text-xs text-white">
