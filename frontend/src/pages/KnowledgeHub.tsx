...
const KnowledgeHub: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'techniques', name: t('Techniques') },
    { id: 'maintenance', name: t('Maintenance') },
    { id: 'benefits', name: t('Benefits') },
  ...
  const content: ContentItem[] = [
    {
      id: '1',
      title: t('Introduction to Rainwater Harvesting'),
      type: 'article',
      category: 'basics',
      thumbnail:
    ...
    {
      id: '2',
      title: t('How to Build a Recharge Pit'),
      type: 'video',
      category: 'techniques',
      thumbnail:
    ...
    {
      id: '3',
      title: t('Maintenance Guide for Storage Tanks'),
      type: 'guide',
    ...
    {
      id: '4',
      title: t('Economic Benefits of Rainwater Harvesting'),
      type: 'article',
      category: 'benefits',
      thumbnail:
        'https://images.unsplash.com/photo-1580519542036-c47de6196ba5?auto=format&fit=crop&w=500&q=60',
      link: 'https://nexteel.in/the-economics-behind-rainwater-harvesting-how-worthwhile-is-the-investment/'
    },
    {
      id: '5',
      title: t('Success Story: Community Harvesting Project'),
      type: 'article',
    ...
    {
      id: '6',
      title: t('DIY Filtration Systems'),
      type: 'video',
      category: 'techniques',
      thumbnail:
  ...
  return (
    <MainLayout>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-800">{t('Knowledge Hub')}</h1>
        <p className="text-gray-600">
          {t('Learn about rainwater harvesting techniques and best practices')}
        </p>
      </div>
        ...
        <Card className="p-6 bg-gradient-to-r from-blue-600 to-blue-800 text-white">
          <div className="md:flex md:items-center md:justify-between">
            <div className="mb-4 md:mb-0 md:mr-6">
              <h2 className="text-xl font-bold mb-2">{t('Rainwater Harvesting Essentials')}</h2>
              <p className="opacity-90 mb-4">
                {t('A comprehensive guide for beginners to advanced practitioners')}
              </p>
              <Button variant="secondary">{t('Start Learning')}</Button>
            </div>
      ...
      <div className="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="relative flex-1">
          ...
          <input
            type="text"
            placeholder={t('Search for articles, videos, guides...')}
              ...
              <Card className="overflow-hidden hover:shadow-md transition-all cursor-pointer">
                ...
                <div className="p-4">
                  <div className="flex items-center text-xs text-gray-500 mb-2">
                    ...
                    {item.duration && <span className="ml-2 flex items-center">• {item.duration}</span>}
                  </div>
